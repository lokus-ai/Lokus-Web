                      ...
                      >
                        {item.external ? (
                          ...
                          <a
                            ...
                            className="relative text-zinc-400 hover:text-white transition-all duration-300 group cursor-pointer"
                          >
                            <motion.span
                              className="relative z-10"
                              whileHover={{ y: -2 }}
                ...
                >
                  {item.external ? (
                    ...
                    <a
                      href={item.href}
                      onClick={(e) => handleAnchorClick(e, item.href)}
                      className="text-2xl font-light text-white hover:text-indigo-400 transition-colors cursor-pointer"
                    >
                      {item.label}
                    </a>
                  )}
